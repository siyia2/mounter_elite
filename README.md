...
In addition i added from v1.2 and up an option generate an image list of any user prompted path, which can significantly help in mounting or converting the images en masse, with the help of the clipboard
